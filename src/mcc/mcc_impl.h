...
extern int64_t (__fastcall* get_player_index_by_xuid_original)(void* a1, libmcc::XUID xuid);
extern int64_t __fastcall get_player_index_by_xuid(void* a1, libmcc::XUID xuid);
